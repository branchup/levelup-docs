...
To award points for specific actions learners take, such as posting in a forum or viewing a resource, use the [action rules](../action-rules/index.mdx) instead.
...
In sitewide mode, conditions defined in the scope of a specific course are not included in course backups at this time. This may be addressed in a future version.
