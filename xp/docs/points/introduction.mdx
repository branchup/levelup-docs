...
In XP, points are essential as they enable learners to earn points and advance through levels. The frequency, quantity, and the criteria for awarding points completely depend on the unique gamification experience that educators plan to create. The number of [levels](./../levels/introduction.mdx) and the difficulty required to progress to the next will also play a part.
...
The [action rules](./action-rules/index.mdx) allow educators to award points for specific actions taken by the learners. They provide a way for rewarding and reinforcing certain behaviours or actions. [Learn more](./action-rules/index.mdx)

:::info

The action rules were introduced in XP 20.
