...
Instructors can use various code snippets to enhance their content material with gamification elements, or to display or hide content based on a learner's level.
...
Our built-in cheat guard prevents learners from abusing the system by discarding repeated actions, or actions that occur too frequently.
...
Award points by placing code snippets almost anywhere in your Moodle site. [Learn more](/points/drops/index.mdx)
...
An additional condition that allows for targeting a specific course is available in the rules screen. This is particularly useful in combination with the _Course completion_ rule as it allows for individual courses to contribute more or fewer points than others.
