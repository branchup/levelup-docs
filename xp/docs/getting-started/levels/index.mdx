...
While you can manually enter the points of each level manually, we recommend that you use the "Quick edit points" widget to automatically calculate and assign points to all levels.
