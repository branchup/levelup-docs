...
Upgrading XP and XP+ to their latest version can be done following steps below.

:::info

Please always consult the **[upgrade notes](./upgrade-notes/)** and **[release notes](/xp/release-notes)** prior to upgrading.
