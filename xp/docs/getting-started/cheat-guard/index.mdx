...
As XP awards points based on learners' actions, some learners may be tempted to abuse the system by repeating similar actions, or by performing quick actions again and again. To remedy this, XP comes with a built-in protection called the "Cheat guard".
...
_Requires [Level Up XP+](/docs/level-up-plus-features)_
...
- Grade rewards
- Awards manually given by educators

Prior to XP+ 1.9, it could happen that course or activity completion rewards were ignored because of the cheat guard, this was not intentional and has been fixed.

Note that the above rewards will still count towards the action or point limits for other actions.
