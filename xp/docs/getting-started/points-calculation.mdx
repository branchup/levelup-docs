...
Only the users with the capability _block/xp:earnxp_ can earn points. By default, this capability is given to the student role. Also, actions triggered by guests, non-logged in users or administrators are ignored.
