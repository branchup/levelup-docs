...
Given to the **all users** role by default.
...
Users with this permission can manage all aspects a plugin's instance. They will be allowed to change any setting, the levels, the rules, the visuals, etc. This permission also allows to edit, import, and reset learners' points.
