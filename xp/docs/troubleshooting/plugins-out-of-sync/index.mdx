...
When you have installed _Level Up XP+_, and later on upgraded _Level Up XP_, the plugins fall out of sync. This means that _Level Up XP+_ is now extending a version of _Level Up XP_ that it was not developed against.
