---
description: Define how many total points can be earned per day.
---
...
- A day is interpreted as _in the last 24 hours_; it is not reset at midnight. The same goes for other time windows.
