...
This page **focuses on quizzes** but its principles apply to most **graded activities**.

:::

There are several ways to give a learner points based on their performance in a quiz. This page outlines three different methods of calculating points:
...
- [Moodle documentation on calculated grade items](https://docs.moodle.org/en/Grade_calculations)