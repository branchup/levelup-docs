...
Activity completion with Level Up XP allows you to reward your students for completing their activities and resources. In order for it to work, _Completion_ must be enabled in Moodle, [more help on this here](/docs/article/enable-completion-in-moodle).
