...
- [xpdrop](#xprop)^: To award points anywhere
- [xpiflevel](#xpiflevel): To display, or hide, some context according to the students' level
...
With this shortcode, points can be awarded virtually anywhere. However, it is not intended to be constructed manually. Please see the [documentation page to use drops](../use-drops/index.mdx).
