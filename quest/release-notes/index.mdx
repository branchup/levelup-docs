...
<ReleaseDate>July 7, 2026</ReleaseDate>
...
<ReleaseDate>April 22, 2026</ReleaseDate>
...
- New objective to track the value of a profile field
- New recruitment automation to recruit based on the state of a challenge
- New recruitment automation to recruit based on the state of a quest
- Streaks can be set to run per fortnight or per month
- Complete section objective can ignore incomplete but unavailable activities
- Watch video objective can target videos within a specific activity

<h3>Quality of life 💪</h3>

- Instructors can view the relationship between quests and navigate to them
- Navigating to a recruit's overview page is available from more places

<h3>Bug fixes 🐛</h3>

- A few language strings were not translatable
- The recruitment automations page did not automatically refresh after making changes
