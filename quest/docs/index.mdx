...
Objectives can be given to learners in four different forms: Quests, Achievements, Challenges and Streaks.
...
**Streaks** are counters that measure how many consecutive days (or weeks) learners complete their objectives. If learners miss a day or week, the streak is broken and the counter resets to zero, encouraging them to act consistently. Overall, streaks help maintain regular and continuous participation.
