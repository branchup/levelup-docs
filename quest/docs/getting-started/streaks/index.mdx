...
Streaks support the following timing options.
...
**Fortnightly**: the objectives must be completed every two weeks.

**Monthly**: the objectives must be completed every month.

:::note

Streaks consider each day to start at 00:00 and end at 23:59 in the server's time zone. Weeks start on Monday and end on Sunday at 23:59. Months end at 23:59 on the last day of the month.
...
Different streaks can be assigned in different courses or sitewide simultaneously. However, within a given context, learners will only see one streak at a time: their oldest running one.
